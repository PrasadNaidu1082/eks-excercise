...
resource "aws_nat_gateway" "eks_ngw" {
  allocation_id = aws_eip.eks_ngw_ip.id
...
resource "aws_route" "eks_r" {
  route_table_id         = aws_vpc.eks_hosted.default_route_table_id
